...
<template>
  <section class="rounded-xl border border-t bg-white p-5 pt-6">
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
        ...
        <div class="mb-4">
          ...
          <div class="relative">
            <input
              v-model="form.name"
              type="text"
              class="w-full rounded-md border px-3 py-2 pr-8 focus:border-orange-500 focus:ring-orange-500"
      ...
      <!-- RIGHT: ĐIỀU KHOẢN -->
      <div>
        <h3 class="mb-3 font-semibold text-orange-500">ĐIỀU KHOẢN & LƯU Ý</h3>
        ...
        <div class="space-y-3 text-sm leading-relaxed text-gray-700">
          <p>
            ...
            <span class="font-medium text-orange-500">1900 6067</span>
            để được hỗ trợ.
          </p>
          ...
          <p>
            ...
            trung chuyển
            <span class="font-medium text-orange-500">1900 6918</span>
    ...
    <label class="flex items-start gap-2 pt-6 text-sm">
      ...
      >
      <span>
        <span class="text-orange-500">Chấp nhận điều khoản</span>
